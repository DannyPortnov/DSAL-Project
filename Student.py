...
class Student:
    ...
    def __init__(self, file_name: str, syllabus_db: SyllabusDB):
        ...
        self._shared_courses: list[SpecialityCourse] = {} # Holds all the courses that were counted in the major or minor already
    ...
    def set_major(self, major: str) -> None:
        ...
        if major == Speciality.COMPUTERS:
            self._major_required_count = {ComputersSpecialityRequiredCourseType.SW: 0, ComputersSpecialityRequiredCourseType.HW: 0}

    def set_minor(self, minor: str) -> None:
        self._minor = minor
        if minor == Speciality.COMPUTERS:
            self._minor_required_count = {ComputersSpecialityRequiredCourseType.SW: 0, ComputersSpecialityRequiredCourseType.HW: 0}
    ...
    def add_mandatory_course(self, course: Course) -> None:
    ...
    def add_speciality_course(self, course: SpecialityCourse) -> None:
    ...
    def _check_finished_courses(self) -> None:
        ...
        """
        all_courses:dict[int, Course | SpecialityCourse] = {**self._mandatory_courses, **self._speciality_courses}
  ...
  # TODO: maybe return a message and write it to the file: wether student is missing points or exceeding the limit
    ...
    def sort_speciality_courses(self) -> None:
        for course in self._speciality_courses.values():
            ...
            self._major_speciality_courses[course.get_speciality_course_type(self._major)].append(course)
            self._minor_speciality_courses[course.get_speciality_course_type(self._minor)].append(course)
    ...
    def update_required_data(self) -> None:
        ...
        req_min_required, req_maj_required = self._syllabus_db.get_required_speciality_required(self._internship_type)
